...
level1bg = new Image();
level1bg.src = './img/level2background.png';
...
jiyuen = new Image();
jiyuen.src = './img/ashDan.png';

renyu = new Image();
renyu.src = './img/renYu.png';
...
function init(){
    ...
    platforms = [new Platform({x: -1, y:500, image: bigThick, w: b}), 
        ...
        new Platform({x: 575 * 2 + 60, y:500, image: mediumThick, w: m}), //dia one
        new Platform({x: 575 * 2 + 500, y: 500, image: smallThick, w: s}),
        new Platform({x: 575 * 2 + 650, y: 500, image: smallThick, w: s}),
        new Platform({x: 575 * 2 + 800, y: 500, image: smallThick, w: s}),
        new Platform({x: 575 * 2 + 950, y: 500, image: smallThick, w: s}),
        new Platform({x: 575 * 2 + 1100, y: 500, image: smallThick, w: s}),
        new Platform({x: 575 * 4 + 100 + 100, y:500, image: bigThick, w: b}),
        new Platform({x: 575 * 4 + 600, y:245, image: bigThin, w: b}),
        new Platform({x: 575 * 6 + 100, y:245, image: mediumThin, w: m}),
        ...
        new Platform({x: 575 * 10 + 500, y: 400, image: smallThick, w: s}),
        new Platform({x: 575 * 10 + 650, y: 400, image: smallThick, w: s}),
        new Platform({x: 575 * 10 + 800, y: 400, image: smallThick, w: s}),
        new Platform({x: 575 * 10 + 950, y: 400, image: smallThick, w: s}),
        new Platform({x: 575 * 12 + 100, y:500, image: bigThick, w: b}),
        new Platform({x: 575 * 13 + 100, y:245, image: mediumThin, w: m}),
        new Platform({x: 575 * 14 - 150, y:245, image: smallThin, w: s}),
        new Platform({x: 575 * 14 + 125, y:245, image: smallThin, w: s}),
        new Platform({x: 575 * 14 + 400, y:245, image: smallThin, w: s}),
    ...
    document.addEventListener("click",  function (e) {
        ...
        if(c.isPointInPath(path2, XY.x, XY.y)) {
            ...
            if(scrollOffset > 400 && scrollOffset < 1200){
                window.open("./diaOneLevelTwo.html")
            }
            if(scrollOffset > 9950 && scrollOffset < 10680){
                window.open("./diaTwoLevelTwo.html")
            }
